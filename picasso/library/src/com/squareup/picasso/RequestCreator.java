...
public class RequestCreator {
    ...
    RequestCreator(final Picasso picasso, final Uri uri, final int resourceId) {
        ...
        data = new Request.Builder(uri, resourceId);
    }
     ...
     * not immediately available in the memory cache then this resource will be set on the target {@link ImageView}.
     */
    ...
    public Bitmap get() throws IOException {
        ...
        final String key = Utils.createKey(finalData);
     ...
     * <blockquote><pre>
     * public class ProfileView extends FrameLayout implements Target { {@literal @}Override public void onBitmapLoaded(Bitmap bitmap, LoadedFrom from) {
     ...
     * <p/>
     * <em>Note:</em> The {@link Callback} param is a strong reference and will prevent your {@link android.app.Activity} or {@link android.app.Fragment} from
     * being garbage collected. If
     * you use this method, it is <b>strongly</b> recommended you invoke an adjacent {@link Picasso#cancelRequest(android.widget.ImageView)} call to prevent
     * temporary leaking.
     */
